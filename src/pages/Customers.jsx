...
const Customers = () => {
  return (
    <div className=''>
        <div className='bg-white rounded-md h-[700px] shadow-xl border-2'>
            {/* top */}
            <div className='py-3 px-5'>
         <h3>DataTable with minimal features & hover style</h3>
            </div>
            {/* content */}
            <div>
            <hr className='bg-gray-200' />
            {/* content data */}
            {/* <div className='px-10 flex items-center w-fit'>
                <table className='w-full text-sm text-gray-500 border-2 py-5'>
                    <thead className=''>
                        <tr className='flex justify-between items-center gap-32'>
                            <th>Customer ID</th>
                            <th>Customer Name</th>
                            <th>Phone Number</th>
                            <th>Status</th>
